			...
			<div class="container">
				<div class="hm-footer-details">
					...
					<div class="row">
						...
						<div class="contact-test flex justify-center text-center">
							<h2 class="text-6xl font-black mb-9">
								contact us
							</h2>

						</div>
						<form class="py-71 flex flex-col" action="">
							<div class="bg-gray-200 flex justify-around align-center rounded-lg py- ">
								<div class=" flex flex-col justify-center  align-center gap-9 border-md text-black ">
									<div>
									...
									<div class="text-center">
										<input class=" text-white submit bg-black  py-1 px-2 rounded-lg transition duration-500 hover:bg-orange-500 hover:text-black" type="submit">
									</div>
								</div>
								<div class="flex justify-center align-center w-auto ">
									<iframe class="my-auto" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d247389.13439789083!2d107.6988268269479!3d14.343046888101457!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x316bff3ec83864ed%3A0x38ea5406b5d91f3f!2sKon%20Tum%2C%20Vietnam!5e0!3m2!1sen!2sma!4v1670230362645!5m2!1sen!2sma" width="400" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
								</div>
							</div>
						</form>
