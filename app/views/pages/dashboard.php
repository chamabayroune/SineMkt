...
<body class="bg-[#969087] font-[sitika]">
  <!--  -->
  <div x-data="setup()" :class="{ 'dark': isDark }">
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased  ">

      <!-- Header -->
      <div class="fixed w-full flex items-center  bg-[#969087] justify-between h-14 text-white z-10 gap-9 ">
        <div class="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-[#fbae2a] ">
          <span class="hidden md:block">chama bayroune</span>
        </div>
        <div class="flex items-center justify-around h-14 bg-[#969087]   ">
          <ul class="flex justify-between">
            <li>
              <div class="block w-px h-6 mx-3 bg-[#969087]  dark:bg-gray-700"></div>
            </li>
            <li>
      ...
      <!-- Sidebar -->
      <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-[#fbae2a] h-full text-white transition-all duration-300 border-none z-10 sidebar">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                          ...
                          <?php foreach ($data['products'] as $Product) : ?>
                            <tbody class="bg-white divide-y divide-gray-200">
                              <tr>
                                <td class="w-9">
                                  <img src="<?= URLROOT . '/images/upload/' . $Product->image ?>" alt="">
                                </td>
